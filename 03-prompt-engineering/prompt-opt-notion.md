...
**Source:** [Notion](https://app.notion.com/320433d7bedb8028a17ff1b0981aafe5)
...
text {INSERT THE ORIGINAL PROMPT HERE} 

### Additional Context

text {OPTIONAL CONTEXT, FILES, PROJECT DETAILS, AUDIENCE, PRIOR DECISIONS, OR CONSTRAINTS} 

### Preferred Output Language

text {BULGARIAN / ENGLISH / PRESERVE THE ORIGINAL LANGUAGE} 

### Preselected AI System

text {NOT SELECTED / GPT-5.6 / CLAUDE / GEMINI / OTHER} 

### Preferred Priority

text {BALANCED / MAXIMUM QUALITY / MINIMUM COST / MAXIMUM SPEED} 
...
* Why this is the optimal choice: No more than three concise sentences.
